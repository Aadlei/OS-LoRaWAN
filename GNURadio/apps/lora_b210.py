...
# Title: Lora B210
# Author: Ådne Sigurd Leirdal & Gustav Halvorsen
...
class lora_b210(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Lora B210", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Lora B210")
        ...
        self.settings = Qt.QSettings("GNU Radio", "lora_b210")
        ...
        self.zeromq_push_sink_0_1 = zeromq.push_sink(gr.sizeof_char, 1, 'tcp://127.0.0.1:5559', 100, False, (-1), True)
        self.zeromq_push_sink_0_0_1 = zeromq.push_sink(gr.sizeof_char, 1, 'tcp://127.0.0.1:5560', 100, False, (-1), True)
        self.zeromq_push_sink_0_0_0_0 = zeromq.push_sink(gr.sizeof_char, 1, 'tcp://127.0.0.1:5558', 100, False, (-1), True)
        self.zeromq_push_sink_0_0_0 = zeromq.push_sink(gr.sizeof_char, 1, 'tcp://127.0.0.1:5561', 100, False, (-1), True)
        ...
        self.zeromq_pull_source_0_0 = zeromq.pull_source(gr.sizeof_char, 1, 'tcp://127.0.0.1:5554', 100, False, (-1), False)
        self.zeromq_pull_source_0 = zeromq.pull_source(gr.sizeof_char, 1, 'tcp://127.0.0.1:5555', 100, False, (-1), False)
        ...
        self.connect((self.blocks_conjugate_cc_0, 0), (self.uhd_usrp_sink_0_0, 0))
        self.connect((self.blocks_conjugate_cc_0_0, 0), (self.uhd_usrp_sink_0, 0))
        ...
        self.connect((self.uhd_usrp_source_0, 0), (self.blocks_multiply_xx_0_0_0, 1))
        self.connect((self.uhd_usrp_source_0, 0), (self.qtgui_freq_sink_x_0_1, 0))
...
def main(top_block_cls=lora_b210, options=None):
